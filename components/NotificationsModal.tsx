  ...
  return (
    ...
    <div className="absolute inset-0 z-[80] bg-black/60 backdrop-blur-sm flex justify-end animate-fade-in">
      ...
      <div className="w-full md:w-[400px] h-full bg-white dark:bg-slate-900 shadow-2xl flex flex-col animate-slide-left">
        ...
        <div className="flex-grow overflow-y-auto p-4 bg-gray-50 dark:bg-slate-800 space-y-3">
              ...
              notifications.map((notif, idx) => (
                 ...
                 <div
                   ...
                   className={`p-4 rounded-xl border transition-colors hover:shadow-sm ${
                     ...
                     notif.read ? `bg-white dark:bg-slate-900 border-gray-100 dark:border-slate-800 ${idx % 2 === 0 ? 'bg-slate-50/60 dark:bg-slate-900/40' : ''} hover:bg-slate-100 dark:hover:bg-slate-900/60` : 'bg-blue-50 border-blue-100 hover:bg-blue-100/70'
                 ...
                 >
                    ...
                    <div className="flex items-start gap-3">
                       ...
                       <div>
                          ...
                          <h3 className={`text-sm font-bold ${notif.read ? 'text-gray-800 dark:text-slate-100' : 'text-black dark:text-slate-100'}`}>{notif.title}</h3>


                          <p className="text-xs text-gray-500 dark:text-slate-400 mt-1 leading-relaxed">{notif.message}</p>


                          <div className="flex items-center gap-1 mt-2 text-[10px] text-gray-400 dark:text-slate-500 font-medium">
        ...
        <div className="p-4 border-t border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900">
           ...
           <button className="w-full py-3 text-xs font-bold text-gray-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-900/60 rounded-xl transition">
