        ...
        <div className="p-6">
          ...
          {success ? (
            ...
            <div className="text-center py-8">
               ...
               <h3 className="text-xl font-bold text-gray-800 dark:text-slate-100">Contraseña Actualizada!</h3>


               <p className="text-gray-500 dark:text-slate-400 text-sm mt-2">Tu seguridad ha sido mejorada.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-4 pr-10 focus:outline-none focus:border-slate-900 dark:focus:border-sky-500 transition"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 focus:outline-none focus:border-slate-900 dark:focus:border-sky-500 transition"
              ...
              <div className="pt-2">
                 ...
                 <button 
                   ...
                   className="w-full bg-slate-900 dark:bg-sky-500 text-white py-3 rounded-xl font-bold hover:bg-slate-900/90 dark:hover:bg-sky-500/90 transition disabled:opacity-50 flex justify-center items-center gap-2"
