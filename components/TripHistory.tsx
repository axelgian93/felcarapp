...
export const TripHistory: React.FC<TripHistoryProps> = ({ 
  ...
  const renderExpenses = () => {
    ...
    return (
      ...
      <div className="p-4 space-y-6 animate-fade-in">
         ...
         <div className="bg-slate-900 dark:bg-sky-500 text-white p-6 rounded-3xl shadow-xl text-center">
            ...
            <p className="text-xs text-gray-400 dark:text-slate-500 font-bold uppercase mt-1">Gasto total este mes</p>
            ...
            <div className="flex items-end justify-between h-32 gap-3">
               ...
               {expensesStats.weeklyData.map((amount, idx) => (
                  ...
                  <div key={idx} className="flex flex-col items-center flex-1 gap-2 group">
                     ...
                     <div className="w-full bg-gray-100 dark:bg-slate-800 rounded-t-lg relative h-full overflow-hidden">
                     ...
                     <span className="text-[10px] font-bold text-gray-400 dark:text-slate-500">Sem {idx + 1}</span>
  ...
  const renderList = () => (
    ...
    <div className="flex-grow overflow-y-auto p-4 bg-gray-50 dark:bg-slate-800 space-y-4">
      ...
      {history.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-black dark:text-slate-100 font-bold">No tienes viajes registrados aún.</p>
        ...
        [...history].sort((a,b) => b.date - a.date).map((trip) => (
          ...
          <div key={trip.id} className="bg-white dark:bg-slate-900 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors hover:bg-slate-50 dark:hover:bg-slate-900/60">
            ...
            <div className="flex items-center gap-3 mb-4 bg-gray-50 dark:bg-slate-800 p-2 rounded-lg">
                ...
                <div className="flex-grow">
                    ...
                    <p className="font-bold text-sm text-gray-900 dark:text-slate-100">{trip.counterpartName}</p>


                    <p className="text-xs text-gray-500 dark:text-slate-400 uppercase">{userRole === UserRole.RIDER ? 'Tu conductor' : 'Pasajero'}</p>
                ...
                {userRole === UserRole.RIDER && (
                  ...
                  <div className="bg-white dark:bg-slate-900 p-1.5 rounded border border-gray-200 dark:border-slate-800">


                     <Car size={16} className="text-gray-600 dark:text-slate-300" />
            ...
            <div className="relative pl-4 space-y-3 border-l-2 border-gray-100 dark:border-slate-800 ml-1.5 mb-3">
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-400 line-clamp-1" title={trip.pickupAddress}>{trip.pickupAddress}</p>
                ...
                <div className="relative">
                  ...
                  <p className="text-xs font-bold text-gray-800 dark:text-slate-100 line-clamp-1" title={trip.destinationAddress}>{trip.destinationAddress}</p>
            ...
            <div className="flex justify-between items-center pt-1">
               ...
               <div className="flex items-center gap-1 text-xs font-bold text-gray-500 dark:text-slate-400 bg-gray-100 dark:bg-slate-800 px-2 py-1 rounded">
  ...
  return (
    ...
    <div className="absolute inset-0 z-50 bg-black/50 backdrop-blur-sm flex justify-end animate-fade-in">
      ...
      <div className="w-full md:w-[400px] h-full bg-white dark:bg-slate-900 shadow-2xl flex flex-col animate-slide-left">
        ...
        <div className="p-5 bg-white dark:bg-slate-900 z-10 border-b border-gray-100 dark:border-slate-800 flex justify-between items-center">


          <div className="flex items-center gap-3">


             <button onClick={onBack || onClose} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-900/60 rounded-full transition">

                <ArrowLeft size={20} className="text-black dark:text-slate-100" />
        ...
        {userRole === UserRole.RIDER && (
           ...
           <div className="flex border-b border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900">
              ...
              <button 
                ...
                className={`flex-1 py-3 text-sm font-bold border-b-2 transition ${activeTab === 'LIST' ?  'border-black text-black dark:text-slate-100' : 'border-transparent text-gray-400 dark:text-slate-500'}`}
              ...
              <button 
                ...
                className={`flex-1 py-3 text-sm font-bold border-b-2 transition ${activeTab === 'EXPENSES' ?  'border-black text-black dark:text-slate-100' : 'border-transparent text-gray-400 dark:text-slate-500'}`}
