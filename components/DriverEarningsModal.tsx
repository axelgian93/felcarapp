...
export const DriverEarningsModal: React.FC<DriverEarningsModalProps> = ({ isOpen, onClose, tripHistory, initialTab = 'EARNINGS' }) => {
  ...
  const renderEarnings = () => {
    ...
    return (
      ...
      <div className="space-y-6 animate-fade-in">
          ...
          {(['today', 'week', 'month'] as const).map((p) => (
            ...
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold rounded-lg transition ${
                ...
                earningsPeriod === p ? 'bg-white dark:bg-slate-900 shadow-sm text-black dark:text-slate-100' : 'text-gray-500 dark:text-slate-400'
        ...
        <div className="bg-slate-900 dark:bg-sky-500 text-white p-6 rounded-3xl shadow-lg text-center">


          <p className="text-gray-400 dark:text-slate-100/70 text-xs font-bold uppercase mb-1">Ganancia Neta ({periodLabels[earningsPeriod]})</p>


          <h2 className="text-4xl font-black">${data.net.toFixed(2)}</h2>


          <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">Disponible para retiro</p>
        ...
        <div className="space-y-3">
          ...
          <h3 className="font-bold text-sm text-gray-900 dark:text-slate-100">Desglose</h3>


          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl p-4 space-y-3 shadow-sm">


            <div className="flex justify-between items-center">


              <span className="text-gray-600 dark:text-slate-300 text-sm">Tarifas de Viajes (Bruto)</span>
            ...
            <div className="border-t border-gray-100 dark:border-slate-800 pt-3 flex justify-between items-center">
              ...
              <span className="font-bold text-black dark:text-slate-100">Total Ganado</span>


              <span className="font-black text-lg border-b-2 border-slate-900 dark:border-sky-500">${data.net.toFixed(2)}</span>
  ...
  const renderHistory = () => (
    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <h3 className="font-bold text-lg text-black dark:text-slate-100">Historial Reciente</h3>
      ...
      <div className="space-y-3 overflow-y-auto max-h-[50vh] pr-1">
        ...
        {driverHistory.map((trip) => (
          ...
          <div key={trip.id} className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-4 shadow-sm">
             ...
             <div className="flex justify-between mb-2">
                ...
                <div>
                   ...
                   <p className="font-bold text-sm flex items-center gap-2 text-gray-900 dark:text-slate-100">


                      {new Date(trip.date).toLocaleDateString()} 


                      <span className="text-gray-400 dark:text-slate-500 font-normal"> {new Date(trip.date).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
                ...
                <div className="font-black text-right text-gray-900 dark:text-slate-100">
             ...
             <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold text-gray-500 dark:text-slate-400">{trip.paymentMethod === PaymentMethod.CASH ? 'Efectivo' : 'Tarjeta'}</span>
             ...
             <div className="text-xs space-y-1 pl-2 border-l-2 border-gray-100 dark:border-slate-800">


                <p className="text-gray-900 dark:text-slate-100 truncate"><span className="w-2 h-2 inline-block bg-green-500 rounded-full mr-1"></span> {trip.pickupAddress}</p>


                <p className="font-medium text-gray-700 dark:text-slate-300 truncate"><span className="w-2 h-2 inline-block bg-gray-400 rounded-full mr-1"></span> {trip.destinationAddress}</p>
             ...
             <div className="mt-3 pt-2 border-t border-gray-50 dark:border-slate-800 flex gap-4 text-[10px] text-gray-400 dark:text-slate-500 font-mono">
    ...
    return (
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-sm">
           ...
           <h3 className="font-bold text-sm mb-4 text-gray-900 dark:text-slate-100">Horas Conectado (Semana Actual)</h3>
              ...
              {stats.dailyBreakdown.map((day, i) => (
                 ...
                 <div key={i} className="flex flex-col items-center gap-2 flex-1">
                    ...
                    <div 
                      ...
                      className="w-full bg-slate-900 dark:bg-sky-500 rounded-t-md transition-all hover:bg-slate-900/80 dark:hover:bg-sky-500/90 relative group"
                    ...
                    >
                       ...
                       <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-slate-900 dark:bg-sky-500 text-white text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none whitespace-nowrap">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 dark:text-slate-500">{day.day}</span>
           ...
           <div className="mt-4 text-center">
              ...
              <span className="text-xs font-bold bg-gray-100 dark:bg-slate-800 text-black dark:text-slate-100 px-4 py-2 rounded-full border border-gray-300 dark:border-slate-700">
                ...
                {(stats.sessionLogs ?? []).map(session => (
                    ...
                    <div key={session.id} className="py-3 flex justify-between items-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold text-gray-900 dark:text-slate-100">{session.date}</p>
                        ...
                        <span className="bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 text-xs font-mono font-bold px-2 py-1 rounded">
  ...
  return (
    ...
    <div className="absolute inset-0 z-[70] bg-black/60 backdrop-blur-sm flex items-end md:items-center justify-center p-4 animate-fade-in">
      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-t-3xl md:rounded-3xl shadow-2xl overflow-hidden animate-slide-up flex flex-col h-[85vh] md:h-auto">
        ...
        <div className="flex border-b border-gray-200 dark:border-slate-800">
           ...
           <button 
             ...
             className={`flex-1 py-4 text-sm font-bold border-b-2 transition ${activeTab === 'EARNINGS' ?  'border-slate-900 text-slate-900 dark:text-slate-100' : 'border-transparent text-gray-400 dark:text-slate-500'}`}
           ...
           <button 
             ...
             className={`flex-1 py-4 text-sm font-bold border-b-2 transition ${activeTab === 'HISTORY' ?  'border-slate-900 text-slate-900 dark:text-slate-100' : 'border-transparent text-gray-400 dark:text-slate-500'}`}
           ...
           <button 
             ...
             className={`flex-1 py-4 text-sm font-bold border-b-2 transition ${activeTab === 'HOURS' ?  'border-slate-900 text-slate-900 dark:text-slate-100' : 'border-transparent text-gray-400 dark:text-slate-500'}`}
        ...
        <div className="flex-grow overflow-y-auto p-6 bg-gray-50 dark:bg-slate-800">
